# Generated by Django 4.2.2 on 2025-01-20 21:57
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('type', models.CharField(choices=[('Appointmen Cancelled', 'Appointmen Cancelled'), ('Appointment Scheduled', 'Appointment Scheduled')], max_length=100)),
